  ...
  sections: {
    ...
    approach: {
      ...
      paragraphs: [
        ...
        "Le calendrier d'une acquisition est dicté par le vendeur, la promesse et ses conditions suspensives. Nous y inscrivons la recherche de financement et signalons tôt ce qui pourrait le mettre en tension : expertise que le prêteur demandera, audit technique, documentation à rassembler. Le dossier présenté aux prêteurs comprend la description de l'actif, son état locatif, la structure emprunteuse, le plan de financement et l'échéancier envisagé. Nous le soumettons aux prêteurs dont la politique correspond à l'actif, menons les échanges et vous aidons à arbitrer entre les offres reçues jusqu'à la signature, avec votre notaire et vos conseils.",
      ],
    },
    analysis: {
