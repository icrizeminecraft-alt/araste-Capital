...
export const acquisition: ExpertiseContent = {
  ...
  sections: {
    ...
    approach: {
      title: "Notre lecture d'une acquisition",
      paragraphs: [
        "Nous commençons par l'actif et par ce qu'il rapporte. Un financement d'acquisition s'apprécie dans la durée : sa cohérence tient à la capacité de l'actif à servir la dette, année après année, dans l'état où il est acheté. Nous examinons donc les baux, la qualité et la diversité des locataires, les charges qui restent au propriétaire, les travaux prévisibles et la situation locative à l'entrée. Lorsque l'actif est occupé par votre propre activité, c'est cette activité que nous analysons. Cette lecture éclaire le niveau d'endettement que l'actif peut porter, avant toute discussion de conditions.",
        "Nous étudions ensuite la structure qui acquiert et la manière dont elle sera financée. Société dédiée, holding, véhicule réunissant plusieurs associés : chaque configuration modifie les garanties envisageables, les engagements demandés aux associés et la lecture qu'en fera le prêteur. Avec vos conseils, nous préparons l'articulation entre apport et dette et un échéancier accordé à l'horizon de détention et à la sortie envisagée au terme de celui-ci. Les garanties proposées restent cohérentes avec l'actif. Pour un portefeuille, la question d'un financement global ou actif par actif se pose dès ce stade, car elle engage les cessions futures.",
        "Le calendrier d'une acquisition est dicté par le vendeur, la promesse et ses conditions suspensives. Nous inscrivons la recherche de financement dans ce calendrier et signalons tôt les points qui pourraient le mettre en tension : expertise que le prêteur demandera, audit technique, documentation à rassembler. Le dossier présenté aux prêteurs comprend la description de l'actif, son état locatif, la structure emprunteuse, le plan de financement et l'échéancier envisagé. Nous le soumettons aux prêteurs dont la politique correspond à l'actif et à la structure, menons les échanges avec eux et vous aidons à arbitrer entre les offres reçues jusqu'à la signature, en coordination avec votre notaire et vos conseils.",
      ],
    },
    analysis: {
      title: "Les éléments nécessaires à l'étude",
      intro: "Un premier échange peut se tenir sur l'actif, le prix et le calendrier ; l'étude proprement dite s'appuie sur les éléments suivants.",
      items: [
        "Description de l'actif, de sa localisation, de son état et des travaux prévus.",
        "État locatif : baux en cours, loyers, échéances, charges et garanties locatives.",
        "Prix d'acquisition, frais annexes et éléments de valorisation disponibles.",
        "Structure d'acquisition envisagée, associés et origine de l'apport.",
        "Calendrier de l'opération : promesse, conditions suspensives, date de signature prévue.",
        "Situation financière de l'emprunteur, de ses associés et des sociétés liées.",
        "Horizon de détention et stratégie pour l'actif : conservation, travaux, arbitrage.",
      ],
    },
    limits: {
