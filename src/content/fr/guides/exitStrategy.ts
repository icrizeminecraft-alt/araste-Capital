...
export const exitStrategy: GuideContent = {
  meta: {
    ...
    description:
      "Ce qu'un prêteur appelle la sortie d'un relais, les grandes familles de sortie, ce qui la rend crédible et la manière de la présenter dans un dossier.",
  },
  title: "La sortie, clé d'un financement relais",
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Le refinancement par un prêt de long terme, instruit par un autre prêteur.",
        "Un encaissement attendu : cession déjà signée, indemnité, créance certaine, produit d'une commercialisation.",
        "L'entrée d'un partenaire ou d'un investisseur au capital de la structure emprunteuse.",
      ],
    },
    {
      ...
      items: [
        ...
        "Des étapes déjà franchies, attestées par des documents datés.",
        "Une date de sortie antérieure à l'échéance du relais, avec une marge.",
        "Un produit de sortie cohérent avec le montant à rembourser.",
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "Un calendrier de sortie qui ne laisse aucune marge avant l'échéance du relais.",
        "Un relais destiné à couvrir une difficulté de trésorerie plutôt qu'une transition identifiée.",
        "Une valeur de sortie qui suppose un marché plus favorable que le marché observé.",
        "Un enchaînement de relais successifs, sans ressource définitive en vue.",
      ],
    },
    {
  ...
  keyPoints: [
    "La sortie est l'événement qui remboursera le relais ; les garanties couvrent son échec, elles ne la remplacent pas.",
    "Une sortie crédible est identifiée, avancée, datée avec une marge et documentée à chaque étape.",
    "Un repli réaliste, même modeste, rassure davantage qu'une promesse de sortie sans alternative.",
    "Les incertitudes exposées dans le dossier pèsent moins que celles découvertes pendant l'instruction.",
  ],
