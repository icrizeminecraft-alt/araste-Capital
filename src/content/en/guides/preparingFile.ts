...
export const preparingFile: GuideContent = {
  ...
  eyebrow: "Method",
  summary:
    "A lender decides on what it reads. This guide describes the documents in a financing file, the order in which an analyst reads them and the mistakes that weigh on the lender's answer.",
  lead: "Why do two comparable transactions receive different answers? Often because one was presented clearly and the other was not. This guide sets out what a financing file should contain, how to order it and how to handle its weak points. The lender can then review it on a clear basis.",
  sections: [
    {
      title: "What the file says about the transaction",
      paragraphs: [
        "A lender does not meet the transaction: it meets the file. It is on that document that the analyst forms a first view, prepares questions and defends the proposal before a credit committee. An incomplete or confused file does not merely generate further questions; it raises doubts about the borrower's command of its own transaction. Conversely, an ordered, quantified and documented file lets the analyst concentrate on substance. The quality of the file does not replace the quality of the transaction, but it determines how the transaction will be read.",
      ],
    },
    {
      ...
      items: [
        ...
        "The intended security is described with the valuation or appraisal reports available.",
        "The exit states how the debt will be repaid, how certain that is and on what timetable.",
        "The supporting documents bring together the articles of association, leases, the sale agreement, existing debt and current commitments.",
      ],
    },
    {
      title: "How an analyst reads",
      paragraphs: [
        "An analyst rarely reads a file from the first page to the last. They begin with the summary to place the transaction and check that it falls within their institution's policy. They then look at the exit and the security: how they will be repaid, and what they can rely on if the intended scenario does not materialise. Then come the figures, which they test against the stated assumptions, followed by the structure and the supporting documents. The file is better arranged in that order than in the chronology of the project.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Presenting a weak point means naming it, measuring its effect on the transaction and stating what is planned in response. That may be additional security, a reserve, a fallback scenario or a condition precedent. This approach shows that the borrower knows the transaction and has already worked on its weak points. It is often what the lender remembers best about a file, and what sets it apart from others.",
      ],
    },
    {
      title: "Frequent mistakes",
      paragraphs: [
        "Three mistakes recur in files that receive a late or negative answer. First, the incomplete file, missing documents the lender will ask for anyway: each further request reopens the review and moves the timetable. Second, unsourced assumptions: an expected rent, a resale value or a margin stated without a verifiable reference lose their credibility, and the rest of the file with them. Third, the unrealistic timetable, which allows neither for the time of review, nor for the valuation, nor for the conditions precedent, and puts the transaction under strain.",
      ],
    },
    {
      title: "The role of your advisers",
      paragraphs: [
        "A financing file rests on elements that only your advisers can establish or validate. The accountant produces the accounts, interim statements and forecasts, and documents the quantified assumptions. The lawyer or notary clarifies the ownership structure, the drafting of the security and the terms of the sale agreement. These legal and tax questions are theirs, not a financing adviser's. Involving your advisers early avoids a document being redone or a structure being called into question during the review.",
        "A financing adviser can help you order these elements, identify what is missing and present the file in the logic of a lender, before it is submitted. They coordinate with your usual advisers without taking their place. A clear division of roles, agreed from the outset, saves everyone time and gives the lender a consistent counterpart throughout the review.",
      ],
    },
  ],
  keyPoints: [
